...
namespace LevelUp.Api.Client.Models.Responses
{
    ...
    public class GiftCardAddValueResponse : IResponse
    {
        /// <summary>
        ...
        {
            return string.Format("Old Value: {0}¢. New Value {1}¢. Value added: {2}¢.", PreviousGiftCardAmountInCents, 
                NewGiftCardAmountInCents, AmountAddedInCents);
        }
    }
}
