...
{
    /// <summary>
    /// Request to retrieves check data stored remotely
    /// </summary>
    public class GetRemoteCheckDataRequest : Request 
    {
        ...
        public GetRemoteCheckDataRequest(string accessToken, string checkUuid) : base (accessToken)
        {
