...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// <copyright file="UserAddressesQueryRequest.cs" company="SCVNGR, Inc. d/b/a LevelUp">
...
{
    /// <summary>
    /// Request retrieve a list of addresses assoicated with a user.
    /// </summary>
    public class UserAddressesQueryRequest : Request
    {
        ...
        public UserAddressesQueryRequest(string accessToken) : base(accessToken) { }
