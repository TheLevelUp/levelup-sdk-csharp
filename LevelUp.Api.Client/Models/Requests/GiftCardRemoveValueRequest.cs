...
namespace LevelUp.Api.Client.Models.Requests
{
    public class GiftCardRemoveValueRequest : Request
    {
        ...
        /// </summary>
        public GiftCardRemoveValueRequestBody Body { get { return _body; } }
        private readonly GiftCardRemoveValueRequestBody _body;
            ...
            : base(accessToken)
        {
            ...
            _body = new GiftCardRemoveValueRequestBody(giftCardQrData, amountInCents);
        }
