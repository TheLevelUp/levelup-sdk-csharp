...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// <copyright file="OrderRequest.cs" company="SCVNGR, Inc. d/b/a LevelUp">
...
namespace LevelUp.Api.Client.Models.Requests
{
    public class OrderRequest : Request
    {
       protected override LevelUpApiVersion _applicableAPIVersionsBitmask
        ...
        /// </summary>
        public Order Body { get { return _body; } }
        private readonly Order _body;
        ...
        public OrderRequest(string accessToken, Order order)
            : base(accessToken)
        {
            _body = order;
        }
