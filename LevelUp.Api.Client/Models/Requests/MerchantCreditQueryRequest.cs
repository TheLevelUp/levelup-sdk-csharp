...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// <copyright file="MerchantCreditQueryRequest.cs" company="SCVNGR, Inc. d/b/a LevelUp">
...
{
    public class MerchantCreditQueryRequest : Request
    {
       protected override LevelUpApiVersion _applicableAPIVersionsBitmask
        ...
        /// <summary>
        /// A Serializable http body for the MerchantCreditQueryRequest
        /// </summary>
        public MerchantCreditQueryRequestBody Body { get { return _body; } }
        private readonly MerchantCreditQueryRequestBody _body;
        ...
        /// <param name="paymentData">The customer's QR code payment data as a string</param>
        public MerchantCreditQueryRequest(string accessToken,
                                        int locationId,
                                        string paymentData, 
            ...
            : base(accessToken)
        {
            ...
            _body = new MerchantCreditQueryRequestBody(paymentData, identifierFromMerchant, items);
        }
