...
namespace LevelUp.Api.Client.Tests.Client.IntegrationTests
{
    internal static class ClientModuleIntegrationTestingUtilities
    {
        ...
        internal static GiftCardAddValueResponse AddGiftCardCreditOnConsumerUserAccount(int amountToAdd)
        {
            return AddGiftCardCreditOnUserAccount(LevelUpTestConfiguration.Current.ConsumerQrData, amountToAdd);
        }

        internal static GiftCardAddValueResponse AddGiftCardCreditOnConsumerWithNoLinkedPaymentUserAccount(int amountToAdd)
        {
            return AddGiftCardCreditOnUserAccount(LevelUpTestConfiguration.Current.ConsumerWithNoLinkedPaymentQrData, amountToAdd);
        }

        internal static GiftCardAddValueResponse AddGiftCardCreditOnUserAccount(string userQrCode, int amountToAdd)
        {
            IRetrieveMerchantFundedGiftCardCredit creditClient = GetSandboxedLevelUpModule<IRetrieveMerchantFundedGiftCardCredit>();
            ...
            GiftCardAddValueResponse response = giftCardClient.GiftCardAddValue(SandboxedLevelUpMerchantAccessToken,
