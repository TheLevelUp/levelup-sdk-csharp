...
using LevelUp.Api.Client.Tests.Client.FunctionalTests;
...
namespace LevelUp.Api.Client.Tests.Client.FunctionalTests
{
    ...
    public class ICreateCreditCardsFunctionalTests
    {
        ...
        {
            const string expectedRequestUrl = ClientModuleFunctionalTestingUtilities.SANDBOX_URL_PREFIX  + "/v15/credit_cards";
