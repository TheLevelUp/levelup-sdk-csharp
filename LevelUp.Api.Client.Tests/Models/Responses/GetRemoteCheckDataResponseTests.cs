...
namespace LevelUp.Api.Client.Tests.Models.Responses
{
    ...
    public class GetRemoteCheckDataResponseTests : ModelTestsBase
    {
        ...
        public void Deserialize()
        {
            ...
            response.OrderIdentifier.Should().BeEquivalentTo(identifier);
            response.DiscountToApply.Should().NotBeNull();
            response.DiscountToApply.Should().IsSameOrEqualTo(discount);
        }
        ...
        public void Deserialize_NullDiscount()
        {
            ...
            response.Should().NotBeNull();
            response.OrderIdentifier.Should().BeEquivalentTo(identifier);
            response.DiscountToApply.Should().BeNull();
        }
