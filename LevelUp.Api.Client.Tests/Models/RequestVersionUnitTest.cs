...
namespace LevelUp.Api.Client.Tests.Models
{
    [TestFixture]
    public class RequestVersionUnitTest
    {
        ...
        public void ModelWithUnspecifiedRequestVersion_ShouldThrow()
        {
            ...
            try
            {
                ...
                Assert.Fail("Failed to throw InvalidOperationException for a request object with unspecified applicable versions");
            }
