...
namespace LevelUp.Api.Client.Models.Responses
{
    ...
    public class GiftCardAddValueResponse
    {
        private GiftCardAddValueResponse()
        {
            Container = new GiftCardAddValueResponseContainer();
        }

        public int AmountAddedInCents { get { return Container.ValueAdded; } }
        ...
        private GiftCardAddValueResponseContainer Container { get; set; }
